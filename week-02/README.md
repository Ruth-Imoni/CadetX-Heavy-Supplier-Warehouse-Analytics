# Week 2: Slow-Moving Inventory Analysis

## Project Overview

Identified products with no sales in 90+ days across warehouse branches to reduce dead stock and free up capital and warehouse space. This analysis flags slow-moving inventory by product and location so the Operations team can decide on markdowns, clearance, or donations.
...
| Name | Role | Task |
|------|------|------|
| [@Ruth-Imoni](https://github.com/Ruth-Imoni) | Scrum Master & SQL Data Analyst | Query design, database analysis, findings |
| [@MLGideon](https://github.com/MLGideon) | Dashboard Developer | Power BI visualization, stakeholder presentation |

---

## Business Questions

1. Which products haven't sold in 90 or more days?
...
![Slow Movers Dashboard](./week-02/Slow_Movers_Dashboard.png)

[View Full Dashboard - Slow Movers Analysis](./week-02/Slow_Movers_DashboardX.pbix)
...
```
[Download: Slow Movers Query.sql](./week-02/slow_movers_analysis_cadetX.sql)
...
[Download: Slow Movers Results CSV](./week-02/slow_movers_analysis_cadetX.csv)
