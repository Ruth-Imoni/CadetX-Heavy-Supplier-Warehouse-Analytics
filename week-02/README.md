...
![Slow Movers Dashboard](./Slow%20Movers%20Dashboard.png)

[`Slow Movers Dashboard X.pbix`](./Slow%20Movers%20Dashboard%20X.pbix)
...
```
[`slow_movers_analysis_cadetX.sql`](./slow_movers_analysis_cadetX.sql)
...
[Download: Slow Movers Results CSV](./slow_movers_analysis_cadetX.csv)
